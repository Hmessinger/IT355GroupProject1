...
public class BankSystem {
    public static void main(String[] args) {
        ...
        if (passord.equals(null) || password.equals("")) {
            throw new IllegalArgumentException("The password must not be null or empty.");
        }

        // In the loop if a user selects to create a new manual password. Check the
        // users input to make sure it isn't null or empty. If it is, then ask them to
